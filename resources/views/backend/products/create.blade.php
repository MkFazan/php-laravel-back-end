...
@section('content')
    <form role="form" id="createUserForm" enctype="multipart/form-data" method="post" action="{{route('products.store')}}">
        @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="number" name="price" value="{{ old('price', null) }}" class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" id="price" placeholder="Enter price" aria-describedby="price-error" aria-invalid="true">
                                @if($errors->has('price'))
                            ...
                            <div class="col-6">
                                ...
                                <input type="number" name="old_price" value="{{ old('old_price', null) }}" class="form-control {{ $errors->has('old_price') ? 'is-invalid' : '' }}" id="old_price" placeholder="Enter old price" aria-describedby="old_price-error" aria-invalid="true">
                        ...
                        <div class="form-group">
                            ...
                            <select name="properties[]" class="form-control js-multiple-properties {{ $errors->has('properties') ? 'is-invalid' : '' }}" multiple="multiple" aria-describedby="properties-error">
                                @foreach($properties as $property)
                                    <option value="{{$property->id}}">{{$property->title_ua}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            <label for="image">Додати головне зображення</label>
                            <div class="input-group">
                                <div class="custom-file">
                                    <input name="image" type="file" class="custom-file-input"
                                           enctype="multipart/form-data" id="image">
                                    <label class="custom-file-label" for="image" id="imageUpload">Вибрати
                                        зображення</label>
                                </div>
