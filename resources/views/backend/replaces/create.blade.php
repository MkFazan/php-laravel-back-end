...
@section('title', 'Нова інформація')

@section('content_header')
    <h1>Нова інформація</h1>
    @include('backend.components.notifications')
@stop

@section('content')
    <form role="form" id="createUserForm" enctype="multipart/form-data"  novalidate="novalidate" method="post" action="{{route('replaces.store')}}">
        @csrf
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="header_ua" value="{{ old('header_ua', null) }}"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description_ua" class="form-control" rows="3"
                                          placeholder="Enter ...">{{old('description_ua')}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="header_ru" value="{{ old('header_ru', null) }}"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description_ru" class="form-control" rows="3"
                                          placeholder="Enter ...">{{old('description_ru')}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="image_replace" id="image_replaceUpload">Вибрати
                                            зображення</label>
                                    </div>
